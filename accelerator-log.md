...
```json
{
  ...
  "database" : "mongo",
  "gitBranch" : "prod-w05-s041-7c753128-da76-4e8f-a803-4b02881e0370",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [default->prod-w05-s041, https://github.com/tsalm-pivotal/tm-forum-java.git->https://github.com/t...(truncated), main->prod-w05-s041-7c7531...(truncated), tmf-product-catalog-management-api-java->product-catalog-mana...(truncated)]
...
┃ ┃ ┃ ┃ ┃  Info Running Chain(Include, ReplaceText, RewritePath, ReplaceText)
