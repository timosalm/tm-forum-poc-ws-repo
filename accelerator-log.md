...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [default->workshops-w02-s002, https://github.com/tsalm-pivotal/tm-forum-java.git->$APP_GIT_REPO_HTTP_U...(truncated), main->main, tmf-product-catalog-management-api-java->product-catalog-mana...(truncated)]
