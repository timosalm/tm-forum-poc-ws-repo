...
```json
{
  ...
  "cnrSubdomain" : "cnr.emea.end2end.link",
  "database" : "mongo",
  "gitBranch" : "prod-w05-s037-06e079c3-2ed3-46cc-b342-3341cd895107",
  "gitUrl" : "https://github.com/tsalm-pivotal/tm-forum-poc-ws-repo.git",
  "namespace" : "prod-w05-s037",
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [default->prod-w05-s037, https://github.com/tsalm-pivotal/tm-forum-java.git->https://github.com/t...(truncated), main->prod-w05-s037-06e079...(truncated), tmf-product-catalog-management-api-java->product-catalog-mana...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.merge.transformations[0].sources[2].<combo>.transformations[1].transformations[1] (RewritePath)
...
┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.merge.transformations[0].sources[2].<combo>.transformations[1].transformations[2] (ReplaceText)
