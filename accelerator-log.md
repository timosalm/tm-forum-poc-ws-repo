...
```json
{
  ...
  "cnrSubdomain" : "tap.oneportal.vodafone.com",
  "database" : "mongo",
  "gitBranch" : "workshops-w06-s001-4a9e4a53-4abd-435b-af77-3a26e8bdf25a",
  "gitUrl" : "https://github.com/tsalm-pivotal/tm-forum-poc-ws-repo.git",
  "namespace" : "workshops-w06-s001",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [default->workshops-w06-s001, https://github.com/tsalm-pivotal/tm-forum-java.git->https://github.com/t...(truncated), main->workshops-w06-s001-4...(truncated), tmf-product-catalog-management-api-java->product-catalog-mana...(truncated)]
