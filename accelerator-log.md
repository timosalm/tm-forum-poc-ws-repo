...
```json
{
  ...
  "database" : "mongo",
  "gitBranch" : "workshops-w04-s001-0341e24b-ee1b-48f6-a8d8-fb2abf8946d2",
  "gitUrl" : "https://github.com/tsalm-pivotal/tm-forum-poc-ws-repo.git",
  "ingressDomain" : "emea.end2end.link",
  "namespace" : "workshops-w04-s001",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [default->workshops-w04-s001, https://github.com/tsalm-pivotal/tm-forum-java.git->https://github.com/t...(truncated), main->workshops-w04-s001-0...(truncated), tmf-product-catalog-management-api-java->product-catalog-mana...(truncated)]
...
┃ ┃ ┃ ┃ engine.transformations[0].merge.transformations[0].sources[6].include (Include)
┃ ┃ ┃ ┃  Info Condition (#database == 'mongo') evaluated to true
