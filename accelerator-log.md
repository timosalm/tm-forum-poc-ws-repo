...
```json
{
  ...
  "database" : "mongo",
  "gitBranch" : "prod-w05-s015-4416b9e7-9ef3-4578-8067-2e906739c2c1",
  "gitUrl" : "https://github.com/tsalm-pivotal/tm-forum-poc-ws-repo.git",
  "namespace" : "prod-w05-s015",
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [default->prod-w05-s015, https://github.com/tsalm-pivotal/tm-forum-java.git->https://github.com/t...(truncated), main->prod-w05-s015-4416b9...(truncated), tmf-product-catalog-management-api-java->product-catalog-mana...(truncated)]
